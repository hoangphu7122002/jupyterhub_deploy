...
# c.Spawner.volumes = {
#     # "{username}": notebook_dir,
#     "jupyterhub_data": "/home/{username}/jupyterhub_data"
# }
...
#     try:
#         # Set the ownership of the home directory to the user's UID and GID
...
#     spawner.user_options = {'username': username}
#     spawner.extra_create_kwargs = {'user': username}
...
# Sử dụng DummyAuthenticator để cấu hình tài khoản và mật khẩu cố định
...
#  Default: '/home/minhnh/.local/share/jupyterhub'
# c.JupyterHub.data_files_path = '/home/minhnh/.local/share/jupyterhub'
